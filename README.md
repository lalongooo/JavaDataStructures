...
##### 1. [Stack] (https://github.com/lalongooo/JavaDataStructures/blob/master/src/com/lalongooo/datastructures/Stack.java)
A simple implementation of the Stack data structure with its standard methods (`push()`, `push()`, `pop()`, `peek()`, `size()`)
